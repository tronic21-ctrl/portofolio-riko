    ...
    <div style={{ minHeight: '100vh', padding: '120px 40px 80px' }}>
      <div style={{ maxWidth: '900px', margin: '0 auto' }}>
        ...
        <motion.p
          ...
          style={{ fontSize: '18px', color: 'var(--text-primary)', lineHeight: 1.8, marginBottom: '60px', maxWidth: '700px' }}
        >
          {a.bio1}{' '}
          <span style={{ color: 'var(--blue-primary)' }}>{a.bio2}</span>
          {a.bio3}{' '}
          <span style={{ color: 'var(--blue-primary)' }}>{a.bio4}</span>
          {a.bio5}{' '}
        ...
        >
          <h2 style={{ fontSize: '28px', marginBottom: '24px', color: 'var(--text-heading)' }}>
            {a.skillsTitle}
          </h2>
          <div style={{
            display: 'grid',
        ...
        >
          <h2 style={{ fontSize: '28px', marginBottom: '32px', color: 'var(--text-heading)' }}>
            {a.journeyTitle}
          </h2>
            ...
            {a.journey.map((item, index) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 style={{ color: 'var(--text-heading)', fontSize: '17px', margin: '4px 0' }}>{item.title}</h3>
                  <p style={{ color: 'var(--text-primary)', fontSize: '15px', lineHeight: 1.6 }}>{item.desc}</p>
                </motion.div>
              )
            })}
          </div>
